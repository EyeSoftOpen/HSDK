namespace EyeSoft.Core.Threading.Tasks.Schedulers
{
	...
	/// </summary>
	public class LimitedConcurrencyLevelTaskScheduler : TaskScheduler, ILoggerTaskScheduler
	{
		private const int DefaultMaxDegreeOfParallelism = int.MaxValue;
		...
		private readonly Action<Exception> logger;
		...
		public LimitedConcurrencyLevelTaskScheduler(int maxDegreeOfParallelism)
			: this(Logger.Instance, maxDegreeOfParallelism)
		{
		}

		public LimitedConcurrencyLevelTaskScheduler(ILogger logger)
			: this(logger.Error, DefaultMaxDegreeOfParallelism)
		{
		}

		public LimitedConcurrencyLevelTaskScheduler(Action<Exception> logger)
			: this(logger, DefaultMaxDegreeOfParallelism)
		{
		}

		public LimitedConcurrencyLevelTaskScheduler(ILogger logger, int maxDegreeOfParallelism)
			: this(logger.Error, maxDegreeOfParallelism)
		{
		}

		public LimitedConcurrencyLevelTaskScheduler(Action<Exception> logger, int maxDegreeOfParallelism)
		{
