...
namespace EyeSoft.Data.EntityFramework.Tracing
{
	...
	/// </remarks>
	public static class TracingProviderConfiguration
	{
		/// <summary>
		/// Initializes static members of the TracingProviderConfiguration class.
		/// </summary>
		static TracingProviderConfiguration()
		{
		...
		{
			DbProviderFactoryBase.RegisterProvider("EF Tracing Data Provider", "EFTracingProvider", typeof(TracingProviderFactory));
		}
	}
}