...
namespace EyeSoft.Data.EntityFramework.Caching
{
	...
	/// </summary>
	internal abstract class CachingDataReaderBase : DbDataReader
	{
		...
		/// starting at location indicated by <paramref name="dataOffset"/>, into the buffer,
		...
		{
			return values[ordinal] is DBNull;
		}
