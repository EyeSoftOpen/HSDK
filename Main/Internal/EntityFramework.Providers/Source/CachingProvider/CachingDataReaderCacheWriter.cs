...
namespace EyeSoft.Data.EntityFramework.Caching
{
	...
	/// </summary>
	internal class CachingDataReaderCacheWriter : CachingDataReaderBase
	{
		private readonly DbDataReader wrappedReader;
		private readonly int maxRows;
		private readonly Action<DbQueryResults> addToCache;

		private DbQueryResults queryResults = new DbQueryResults();

		/// <summary>
		/// Initializes a new instance of the CachingDataReaderCacheWriter class.
		/// </summary>
		...
		public CachingDataReaderCacheWriter(DbDataReader wrappedReader, int maxRows, Action<DbQueryResults> addToCache)
		{
			this.wrappedReader = wrappedReader;
			this.addToCache = addToCache;
			this.maxRows = maxRows;
			for (var i = 0; i < wrappedReader.FieldCount; ++i)
			{
				queryResults.ColumnNames.Add(wrappedReader.GetName(i));
			}
		}
