...
namespace EyeSoft.Data.EntityFramework.Toolkit
{
	...
	public class DbCommandWrapper : DbCommand
	{
		...
		private readonly DbCommandDefinitionWrapper definition;
		...
		/// </returns>
		[SuppressMessage(
			"Microsoft.Security", "CA2100:Review SQL queries for security vulnerabilities", Justification = "This is a pass-through")]
		...
		/// The default is Both unless the command is automatically generated. Then the default is None.
		/// </returns>
		...
		protected override DbConnection DbConnection
		{
			...
			set
			{
				var conn = (DbConnectionWrapper)value;
				if (conn != null)
				{
					connection = conn;
					wrappedCommand.Connection = conn.WrappedConnection;
				}
				else
				{
					connection = null;
		...
		/// <summary>
		/// Gets or sets the <see cref="P:System.Data.Common.DbCommand.DbTransaction"/>
		/// within which this <see cref="T:System.Data.Common.DbCommand"/> object executes.
		/// </summary>
		/// <value></value>
		/// <returns>
