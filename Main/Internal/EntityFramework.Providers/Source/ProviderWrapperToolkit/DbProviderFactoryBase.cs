...
namespace EyeSoft.Data.EntityFramework.Toolkit
{
	...
	{
		private readonly DbProviderServices providerServices;

		/// <summary>
		/// Initializes a new instance of the DbProviderFactoryBase class.
		/// </summary>
		/// <param name="providerServices">The provider providerServices.</param>
		...
		public static void RegisterProvider<TProviderFactory>()
			where TProviderFactory : DbProviderFactory
		{
			var type = typeof(TProviderFactory);

			RegisterProvider(type.Name, type.Namespace, type);
		}
